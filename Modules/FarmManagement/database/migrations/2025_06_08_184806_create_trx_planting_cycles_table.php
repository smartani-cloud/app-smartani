...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('trx_planting_cycles', function (Blueprint $table) {
			...
			$table->decimal('minimum_yield_kg', 8, 2)->default(0); // Perkiraan hasil panen minimum (kg)
			$table->decimal('maximum_yield_kg', 8, 2)->default(0); // Perkiraan hasil panen maksimum (kg)
