...
class ProductCategoryController extends Controller
{
    ...
    {
        $data = $request->id ? ProductCategory::find($request->id) : null;
        $active = $this->active;
        $route = $this->route;
    ...
    public function update(Request $request)
    {
        ...
        $count = ProductCategory::where('name',$request->name)->where('id','!=',$request->id)->count();
