...
class SalesTypeController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->active = 'Jenis Penjualan';
        $this->route = 'sales-type';
    }
    ...
    public function store(Request $request)
    {
        ...
        $count = SalesType::where('name', $request->name)->count();
    ...
    {
        $data = $request->id ? SalesType::find($request->id) : null;
        $active = $this->active;
        $route = $this->route;
    ...
    public function update(Request $request)
    {
        ...
        $item = SalesType::find($request->id);
        $count = SalesType::where('name',$request->name)->where('id','!=',$request->id)->count();
