...
<div class="d-sm-flex align-items-center justify-content-between mb-2">
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="{{ route($route.'.show', ['id' => $data->greenhouse->id_greenhouse]) }}">{{ $data->greenhouse->id_greenhouse }}</a></li>
    ...
    <div class="card shadow">
      ...
      <div class="card-body">
        <form action="{{ route($route.'.update') }}" id="update-form" method="post" enctype="multipart/form-data" accept-charset="utf-8">
          {{ csrf_field() }}
          {{ method_field('PUT') }}
          <input id="id" type="hidden" name="id" required="required" value="{{ $data->greenhouse->id_greenhouse }}">
          <div class="row mb-4">
            <div class="col-12">
              ...
              <div class="form-group">
                <div class="row mb-3">
                  ...
                  <div class="col-lg-9 col-md-8 col-12">
                    <input id="inputName" class="form-control @error('name') is-invalid @enderror" type="text" name="name" placeholder="mis. Greenhouse Baturraden" value="{{ old('name',$data->name) }}" maxlength="255" required="required">
                    @error('name')
              ...
              <div class="form-group">
                <div class="row mb-3">
                  ...
                  <div class="col-lg-7 col-md-6 col-12">
                    <img src="{{ $data->greenhouse->photo ? asset($data->greenhouse->photoPath) : asset('img/avatar/default.png') }}" id="preview" class="img-thumbnail photo-preview">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-lg-4 col-md-6 col-12">
                    <select class="select2 form-control @error('irrigation_system') is-invalid @enderror" name="irrigation_system" id="selectIrrigationSystem" required="required">
                      ...
                      <option value="{{ $s->code }}" {{ old('irrigation_system',$data->greenhouse->irrigationSystem ? $data->greenhouse->irrigationSystem->code : null) == $s->code ? 'selected' : '' }}>{{ $s->name }}</option>
                      @endforeach
                    </select>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-lg-3 col-md-4 col-8">
                    <div class="input-group bootstrap-touchspin bootstrap-touchspin-injected">
                      <input id="inputRt" type="text" name="rt" class="form-control @error('rt') is-invalid @enderror" value="{{ old('rt', $data->greenhouse->rt) }}" required="required">
                    </div>
                    @error('rt')
            ...
            <div class="col-lg-10 col-md-12">
              <div class="form-group">
                <div class="row mb-3">
                  ...
                  <div class="col-lg-3 col-md-4 col-8">
                    <div class="input-group bootstrap-touchspin bootstrap-touchspin-injected">
                      <input id="inputRw" type="text" name="rw" class="form-control @error('rw') is-invalid @enderror" value="{{ old('rw', $data->greenhouse->rw) }}" required="required">
                    </div>
                    @error('rw')
                    <span class="mt-1 text-danger d-block">{{ $message }}</span>
                    @enderror
                ...
                <div class="row">
                  ...
                  <div class="col-lg-2 col-md-4 col-6">
                    <div class="input-group">
                      <input type="text" id="area" class="form-control @error('area') is-invalid @enderror number-separator" name="area" value="{{ old('area',number_format($data->greenhouse->area, 0, ',', '.')) }}" placeholder="mis. 1.250" maxlength="10">
                      <div class="input-group-append">
            ...
            <div class="col-lg-10 col-md-12">
              <div class="form-group">
                <div class="row">
                  ...
                  <div class="col-lg-2 col-md-4 col-6">
                    <div class="input-group">
                      <input type="text" id="elevation" class="form-control @error('elevation') is-invalid @enderror number-separator" name="elevation" value="{{ old('elevation',number_format($data->greenhouse->elevation, 0, ',', '.')) }}" placeholder="mis. 350" maxlength="10">
                      <div class="input-group-append">
              ...
              <div class="form-group">
                <div class="row">
                  ...
                  <div class="col-lg-6 col-md-5 col-12">
                    <div class="input-group">
                      <input type="number" id="gps_lat" class="form-control @error('gps_lat') is-invalid @enderror" name="gps_lat" step="0.0000001" min="-90" max="90" value="{{ old('gps_lat',$data->greenhouse->gps_lat) }}" placeholder="mis. -7.4935">
                      <div class="input-group-append">
            ...
            <div class="col-lg-10 col-md-12">
              <div class="form-group">
                <div class="row">
                  ...
                  <div class="col-lg-6 col-md-5 col-12">
                    <div class="input-group">
                      <input type="number" id="gps_lng" class="form-control @error('gps_lng') is-invalid @enderror" name="gps_lng" step="0.0000001" min="-180" max="180" value="{{ old('gps_lng',$data->greenhouse->gps_lng) }}" placeholder="mis. 109.3316">
                      <div class="input-group-append">
                        <span class="input-group-text">&deg;</span>
                      </div>
                    </div>
                ...
                <div class="row mb-3">
                  ...
                  <div  class="col-lg-9 col-md-8 col-12">
                    <select class="select2-multiple form-control @error('owner') is-invalid @enderror" name="owner[]" multiple="multiple" id="select2Owner">
                      @foreach($owners as $o)
                      <option value="{{ $o->id }}" {{ old('owner', $data->greenhouseOwners->pluck('id')->toArray()) && is_array(old('owner', $data->greenhouseOwners->pluck('id')->toArray())) && in_array($o->id, old('owner', $data->greenhouseOwners->pluck('id')->toArray())) ? 'selected' : '' }}>{{ $o->name }}</option>
                      @endforeach
                    </select>
                  </div>
                </div>
