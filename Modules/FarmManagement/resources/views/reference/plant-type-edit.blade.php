    ...
    <div class="col-lg-10 col-md-12">
      <div class="form-group">
        <div class="row mb-3">
          ...
          <div class="col-lg-3 col-md-4 col-12">
            <select class="form-control form-control-sm @error('editCategory') is-invalid @enderror" name="editCategory" id="selectEditCategory" required="required">
              @foreach($categories as $c)
              <option value="{{ $c->id }}" {{ old('editCategory',$data->category_id) == $c->id ? 'selected' : '' }}>{{ $c->name }}</option>
              @endforeach
            </select>
            @error('editCategory')
