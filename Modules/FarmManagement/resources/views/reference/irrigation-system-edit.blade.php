    ...
    <div class="col-lg-10 col-md-12">
      <div class="form-group">
        <div class="row mb-3">
          ...
          <div class="col-lg-9 col-md-8 col-12">
            <textarea class="form-control form-control-sm @error('editDesc') is-invalid @enderror" name="editDesc" maxlength="255" rows="4" required="required">{{ old('editDesc',$data->desc) }}</textarea>
            @error('editDesc')
            <span class="text-danger">{{ $message }}</span>
            @enderror
          </div>
