...
<div class="row mb-4">
  <div class="col-12">
    <div class="card shadow">
      ...
      <div class="card-body">
        <form action="{{ route($route.'.store') }}" id="add-form" method="post" enctype="multipart/form-data" accept-charset="utf-8">
          {{ csrf_field() }}
          <div class="row">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-5 col-md-6 col-12">
                    <div class="input-group">
                      ...
                      <input type="text" id="min_price" class="form-control @error('min_price') is-invalid @enderror number-separator" name="min_price" value="{{ old('min_price') }}" placeholder="mis. 20.000" maxlength="10">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-5 col-md-6 col-12">
                    <div class="input-group">
                      ...
                      <input type="text" id="max_price" class="form-control @error('max_price') is-invalid @enderror number-separator" name="max_price" value="{{ old('max_price') }}" placeholder="mis. 40.000" maxlength="10">
                      <div class="input-group-append">
                        <span class="input-group-text">/ ons</span>
                      </div>
                    </div>
            ...
            <div class="col-lg-10 col-md-12">
              <div class="row">
                ...
                <div class="col-lg-9 col-md-6 col-12">
                  <div class="text-left">
                    <button class="btn btn-brand-green-dark" type="submit">Tambah</button>
                  </div>
                </div>
              </div>
            </div>
