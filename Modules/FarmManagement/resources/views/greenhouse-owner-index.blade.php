          ...
          <table class="table table-bordered dataTable" id="dataTable" width="100%" cellspacing="0" role="grid" aria-describedby="dataTable_info" style="width: 100%;">
            ...
            <tbody>
              ...
              <tr>
                <td>{{ $no++ }}</td>
                <td>
                  <a href="{{ route($route.'.show', ['id' => $d->id]) }}" class="text-info detail-link" target="_blank">
                    <div class="avatar-small d-inline-block">
                      <img src="{{ asset($d->showPhoto) }}" alt="user-{{ $d->id }}" class="avatar-img rounded-circle mr-1">
                    </div>
                    {{ $d->name }}
                  </a>
                </td>
                <td>{{ $d->nik }}</td>
                <td>{{ $d->birth_place }}</td>
                <td>{{ date('Y-m-d',strtotime($d->birth_date)) }}</td>
                <td>{{ $d->units()->count() }}</td>
                <td>
                	@if($d->activeStatus->code == 'active')
                ...
                <td>
                  <a href="{{ route($route.'.show',['id' => $d->id]) }}" class="btn btn-sm btn-brand-purple-dark"><i class="fas fa-eye"></i></a>
