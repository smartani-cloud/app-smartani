          ...
          <div class="row">
            <div class="col-lg-10 col-md-12">
              <div class="form-group">
                <div class="row">
                  <div class="col-lg-3 col-md-4 col-12">
                    <label for="normal-input" class="form-control-label">Unit</label>
                  </div>
                  <div class="col-lg-2 col-md-3 col-4">
                    <input type="text" id="unit" class="form-control form-control-sm @error('unit') is-invalid @enderror" name="unit" value="{{ old('unit') }}" maxlength="255" required="required">
                    @error('unit')
                    <span class="text-danger">{{ $message }}</span>
                    @enderror
                  </div>
  ...
  <div class="col-12">
    <div class="card shadow">
      ...
      <div class="card-body">
        ...
        @endif
        @if($errors->has('editName') || $errors->has('editUnit'))
