      ...
      <div class="form-group">
        <div class="row mb-3">
          ...
          <div class="col-lg-2 col-md-3 col-4">
            <input type="text" id="editUnit" class="form-control form-control-sm @error('editUnit') is-invalid @enderror" name="editUnit" value="{{ old('editUnit',$data->unit) }}" maxlength="255" required="required">
            @error('editUnit')
            <span class="text-danger">{{ $message }}</span>
            @enderror
          </div>
