...
class DeskripsiKhatamanController extends Controller
{
    /**
    ...
    public function __construct()
    {
        ...
        $modul = 'deskripsi-khataman';
        $this->modul = $modul;
        $this->active = 'Deskripsi Khataman';
        ...
        if($semester){
            ...
            if($tingkat){
                ...
                if($mataPelajaran){
                    // Inti function
                    $messages = [
                        'category.required' => 'Mohon pilih salah satu kategori',
                    ...
                    if(in_array($request->category,['kelancaran','kebagusan'])){
                        $type_id = $request->category == 'kelancaran' ? 11 : 12;
                        ...
                        Session::flash('danger', 'Kategori tidak ditemukan');
                    }
