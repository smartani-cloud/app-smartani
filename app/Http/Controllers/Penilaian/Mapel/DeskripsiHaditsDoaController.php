...
class DeskripsiHaditsDoaController extends Controller
{
    /**
    ...
    public function __construct()
    {
        ...
        $modul = 'deskripsi-hadits-doa';
        $this->modul = $modul;
        $this->active = 'Deskripsi Hafalan Hadits & Doa';
        ...
        if($semester){
            ...
            if($tingkat){
                ...
                if($mataPelajaran){
                    ...
                    if(in_array($request->category,['hadits','doa'])){
                        $type_id = $request->category == 'hadits' ? 13 : 14;
