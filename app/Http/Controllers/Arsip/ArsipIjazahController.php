...
class ArsipIjazahController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('penilaian.arsipijazah.index', compact('siswas', 'kelas'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $FileName = 'Ijazah_' . $siswa->identitas->student_nis . '_' . $siswa->identitas->student_name . '.' . $extFile;
        ...
        return redirect('/kependidikan/ijazah/arsip')->with('sukses', 'Unggah Ijazah Siswa Berhasil');
    }
