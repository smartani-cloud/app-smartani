  ...
  <div class="col-12">
    <div class="card">
      <div class="card-header py-3 bg-brand-green-dark d-flex flex-row align-items-center justify-content-between">
        <h6 class="m-0 font-weight-bold text-white">Form Pegawai</h6>
      </div>
      <div class="card-body p-4">
        <form action="{{ route('pegawai.simpan') }}" id="add-form" method="post" enctype="multipart/form-data" accept-charset="utf-8" onsubmit="return validateDate('inputBirthDate','birthDateError')">
          {{ csrf_field() }}
          <div class="row mb-4">
            <div class="col-12">
          ...
          <div class="row">
            <div class="col-lg-10 col-md-12">
              <div class="form-group">
                <div class="row mb-3">
                  <div class="col-lg-3 col-md-4 col-12">
                    <label for="inputUnit" class="form-control-label">Unit <span class="text-danger">*</span></label>
                  </div>
                  <div class="col-lg-9 col-md-8 col-12">
                    <select aria-label="Unit" name="unit" id="inputUnit" title="Unit" class="form-control @error('unit') is-invalid @enderror" required="required">
                      <option value="" {{ old('unit') ? '' : 'selected' }} disabled="disabled">Pilih salah satu</option>
                      @foreach($unit as $u)
          ...
          <div class="row">
            <div class="col-lg-10 col-md-12">
              <div class="form-group">
                <div class="row mb-3">
                  <div class="col-lg-3 col-md-4 col-12">
                    <label for="inputPosition" class="form-control-label">Jabatan <span class="text-danger">*</span></label>
                  </div>
                  <div class="col-lg-9 col-md-8 col-12">
                    <select aria-label="Jabatan" name="position" id="inputPosition" title="Jabatan" class="form-control @error('position') is-invalid @enderror" required="required">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-lg-9 col-md-8 col-12">
                    ...
                    <div class="custom-control custom-radio mb-1">
                      <input type="radio" id="statusOpt{{ $s->id }}" name="employee_status" class="custom-control-input" value="{{ $s->id }}" {{ old('employee_status') == $s->id ? 'checked' : '' }} required="required">
