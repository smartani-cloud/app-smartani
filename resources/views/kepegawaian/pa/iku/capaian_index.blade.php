                ...
                <div class="col-md-6 col-12 mb-3">
                  <div class="row py-2 rounded border border-light mr-2">
                    <div class="col-8 d-flex align-items-center">
                      ...
                      <div>
                        <a class="font-weight-bold text-dark" href="{{ route('iku.'.$category->nameLc.'.index', ['tahun' => $tahun->academicYearLink, 'unit' => $u->name])}}">
                          {{ $u->name }}
                        </a>
                      </div>
                    </div>
                    <div class="col-4 d-flex justify-content-end align-items-center">
                      <a href="{{ route('iku.'.$category->nameLc.'.index', ['tahun' => $tahun->academicYearLink, 'unit' => $u->name])}}" class="btn btn-sm btn-outline-brand-green-dark">Pilih</a>
                    </div>
                  </div>
                </div>
                @endforeach
