        ...
        <div class="d-flex flex-row mb-2">
          ...
          <div class="pl-3">
            ...
            <h5 class="mt-2 mb-0">
              ...
              <span class="badpge badge-warning font-weight-normal">PHK</span>
              @endif
            </h5>
          </div>
        </div>
            ...
            <div class="row">
              <div class="col-lg-10 col-md-12">
                <div class="row mb-3">
                  ...
                  <div class="col-lg-9 col-md-8 col-12">
                    {{ date('j F Y', strtotime($pegawai->spk()->latest()->first()->period_start)) }} s.d. {{ date('j F Y', strtotime($pegawai->spk()->latest()->first()->period_end)) }}
                  </div>
                </div>
              </div>
            </div>
