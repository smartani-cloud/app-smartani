              ...
              <div class="form-group mb-0">
                <div class="row">
                  ...
                  <div class="col-lg-9 col-md-8 col-12">
                    <select aria-label="Tahun" name="tahunajaran" class="form-control" disabled="disabled">
                      <option value="#">{{ $aktif->academic_year }}</option>
                    </select>
                  </div>
                </div>
              </div>
    ...
    <div class="col-12">
        <div class="card">
            <ul class="nav nav-pills p-3">
              <li class="nav-item">
                <a class="nav-link active" href="{{ route('pelatihan.saya.index') }}">Mendatang</a>
              </li>
              <li class="nav-item">
                <a class="nav-link text-brand-green" href="{{ route('pelatihan.saya.riwayat') }}">Riwayat</a>
              </li>
            </ul>
        </div>
    </div>
        ...
        <div class="card">
            ...
            <div class="card-body p-3">
              ...
              <div class="text-center mx-3 mt-4 mb-5">
                <h3>Mohon Maaf,</h3>
                <h6 class="font-weight-light mb-3">Belum ada data materi pelatihan yang ditemukan</h6>
              </div>
              @endif
            </div>
        </div>
