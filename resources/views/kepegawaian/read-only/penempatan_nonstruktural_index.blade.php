...
<div class="d-sm-flex align-items-center justify-content-between mb-2">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Nonstruktural</li>
    </ol>
</div>
  ...
  <div class="col-12">
    <div class="card">
      <div class="card-body p-3">
        <form action="{{ route('nonstruktural.index') }}" method="get">
          <div class="row">
                ...
                <div class="col-md-6 col-12 mb-3">
                  <div class="row py-2 rounded border border-light mr-2">
                    <div class="col-8 d-flex align-items-center">
                      ...
                      <div>
                        <a class="font-weight-bold text-dark" href="{{ route('nonstruktural.show', ['tahunajaran' => $aktif->academicYearLink, 'unit' => $u->name])}}">
                          {{ $u->name }}
                        </a>
                      </div>
                    </div>
                    <div class="col-4 d-flex justify-content-end align-items-center">
                      <a href="{{ route('nonstruktural.show', ['tahunajaran' => $aktif->academicYearLink, 'unit' => $u->name])}}" class="btn btn-sm btn-outline-brand-green-dark">Pilih</a>
                    </div>
                  </div>
                </div>
                @endif
