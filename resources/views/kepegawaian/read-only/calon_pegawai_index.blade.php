    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 font-weight-bold text-brand-green">Calon Pegawai Tidak Tetap Lulus Seleksi</h6>
            </div>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <i class="fa fa-lg fa-check-circle text-success mr-1" data-toggle="tooltip" data-html="true" data-original-title="Disetujui oleh {{ $c->accEdukasi->name }}<br>{{ date('j M Y H.i.s', strtotime($c->education_acc_time)) }}"></i>
                        @else
