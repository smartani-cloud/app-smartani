                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="#" class="btn btn-sm btn-success" data-toggle="modal" data-target="#disjoin-confirm" onclick="disjoinModal('{{ addslashes(htmlspecialchars($p->pegawai->name)) }}', '{{ route('phk.validasi', ['id' => $p->id]) }}')"><i class="fas fa-check"></i></a>
                        @else
...
@include('template.modal.phk_validasi')
