<<<<<<< HEAD
<form action="{{ route('nonstruktural.perbarui', ['tahunajaran' => $aktif->academicYearLink, 'unit' => $unit->name]) }}" id="penempatan-form" method="post" enctype="multipart/form-data" accept-charset="utf-8">
  {{ csrf_field() }}
  {{ method_field('PUT') }}
