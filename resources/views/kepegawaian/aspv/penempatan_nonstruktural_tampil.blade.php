        ...
        <div class="card">
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                ...
                <div class="float-right">
                  ...
                  @endif
                  <a class="m-0 btn btn-brand-green-dark btn-sm" href="{{ route('nonstruktural.ekspor',['tahunajaran' => $aktif->academicYearLink, 'unit' => $unit->name]) }}">Ekspor <i class="fas fa-file-export ml-1"></i></a>
                </div>
            </div>
            <div class="card-body p-3">
