                ...
                <table id="dataTable" class="table align-items-center table-flush">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="#" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#edit-form" onclick="editModal('{{ route('evaluasi.ubah') }}','{{ $e->id }}')" data-toggle="modal" data-target="#edit-form"><i class="fas fa-eye"></i></a>
                      </td>
                    </tr>
                    @endforeach
                  </tbody>
