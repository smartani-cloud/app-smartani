...
<div class="d-sm-flex align-items-center justify-content-between mb-2">
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="{{ route('apby.index', ['jenis' => $jenisAktif->link,'tahun' => $tahun->academicYearLink])}}">{{ $tahun->academic_year }}</a></li>
...
<div class="row">
    <div class="{{ $apbyAktif && $apbyAktif->detail()->count() > 0 && $apbyAktif->director_acc_status_id == 1? 'col-lg-4 ' : 'col-lg-6 ' }}col-12 mb-4">
        <div class="card">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <h6 id="summary" class="mb-0">
                            ...
                            @if($apbyAktif->director_acc_status_id != 1)
    ...
    @if($apbyAktif && $apbyAktif->detail()->count() > 0 && $apbyAktif->director_acc_status_id == 1)
...
<div class="row mb-4">
    <div class="col-12">
        <div class="card">
        <form action="{{ route('apby.perbarui',['jenis' => $jenisAktif->link, 'tahun' => $tahun->academicYearLink, 'anggaran' => $anggaranAktif->anggaran->link]) }}" id="apby-form" method="post" enctype="multipart/form-data" accept-charset="utf-8">
          {{ csrf_field() }}
          <input type="hidden" name="validate" value="">
                ...
                <table class="table align-items-center table-flush">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                @if($apbyAktif->finance_acc_status_id != 1 || $apbyAktif->director_acc_status_id == 1 || ($apbyAktif->director_acc_status_id != 1 && $d->akun->is_fillable < 1))
            ...
            <div class="card-footer">
                @if($apbyAktif->finance_acc_status_id == 1 && $apbyAktif->director_acc_status_id != 1)
                <div class="row">
                    <div class="col-12">
  ...
  <div class="modal-dialog modal-confirm" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer justify-content-center">
        ...
        <form action="{{ route('apby.validasi.semua',['jenis' => $jenisAktif->link, 'tahun' => $tahun->academicYearLink, 'anggaran' => $anggaranAktif->anggaran->link]) }}" method="post">
          {{ csrf_field() }}
          {{ method_field('PUT') }}
...
@endif
@if($apbyAktif && $apbyAktif->finance_acc_status_id == 1 && $apbyAktif->director_acc_status_id != 1)
<div class="modal fade" id="saveAccept" tabindex="-1" role="dialog" aria-labelledby="simpanSetujuiModalLabel" aria-hidden="true" style="display: none;">
  <div class="modal-dialog modal-confirm" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer justify-content-center">
        <button type="button" class="btn btn-danger mr-1" data-dismiss="modal">Tidak</button>
        <button type="submit" id="saveAcceptBtn" class="btn btn-success" data-form="apby-form">Ya, Simpan & Setujui</button>
      </div>
    </div>
  </div>
</div>
