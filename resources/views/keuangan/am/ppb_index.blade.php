    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                ...
                @if(count($ppaAcc) > 0)
                <a class="m-0 float-right btn btn-brand-green-dark btn-sm" href="{{ route('ppb.buat', ['jenis' => $jenisAktif->link, 'tahun' => !$isYear ? $tahun->academicYearLink : $tahun])}}">Buat Baru <i class="fas fa-plus-circle ml-1"></i></a>
                @else
                <button type="button" class="m-0 float-right btn btn-brand-green-dark btn-sm" disabled="disabled">Buat Baru <i class="fas fa-plus-circle ml-1"></i></button>
                @endif
                @endif
            </div>
            @if($bbk && count($bbk) > 0)
