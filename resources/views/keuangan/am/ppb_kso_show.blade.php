                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <i class="fa fa-lg fa-check-circle text-info" data-toggle="tooltip" data-html="true" data-original-title="Disepakati oleh Auliya dan Letris dengan perubahan<br>Awal: {{ number_format($b->ppa->detail()->sum('value_fam'), 0, ',', '.') }}"></i>
                                    @else
