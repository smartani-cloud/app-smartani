  ...
  <div class="col-12">
    <div class="card">
      <div class="card-body p-3">
        ...
        @endphp
        @if($lppaAktif->finance_acc_status_id == 1 && ($hasSelisih && $selisihLebih > 0) && $isPa)
...
<div class="row mb-4">
    <div class="col-12">
        ...
        @endif
            ...
            @endif
            @if($isPa && ($lppaAktif->finance_acc_status_id == 1 && ($hasSelisih && $selisihKurang < 0)))
                    ...
                    <tbody>
                        ...
                        <tr id="l-{{ $l->id }}">
                            ...
                            <td>
								...
								@else
                                @if($isPa && $lppaAktif->detail()->where('acc_status_id',1)->count() < ($lppaAktif->detail()->count()) && $l->ppaDetail->value > 0)
            ...
            <div class="card-footer">
                @if($isPa && ($lppaAktif->detail()->where('acc_status_id',1)->count() < ($lppaAktif->detail()->count())))
                <div class="row">
                    <div class="col-12">
...
@if($isPa && ($lppaAktif && $lppaAktif->detail()->where('acc_status_id',1)->count() < ($lppaAktif->detail()->count())))
