                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @if($d->value_fam && $d->value_fam > 0 && $d->value_fam != $d->value_president)
                                    <i class="fa fa-lg fa-check-circle text-info mr-1" data-toggle="tooltip" data-html="true" data-original-title="Disetujui dengan perubahan oleh {{ Auth::user()->pegawai->is($d->accKetua) ? 'Anda' : $d->accKetua->name }}<br>{{ date('d M Y H.i.s', strtotime($d->president_acc_time)) }}<br>Awal: {{ $d->valueFamWithSeparator }}"></i>
                                    @else
