    ...
    <div class="card shadow">
      ...
      <div class="card-body px-4 py-3">
        ...
        <form action="{{ route($route.'.store') }}" id="addItemForm" method="post" enctype="multipart/form-data" accept-charset="utf-8">
              ...
              <div class="form-group">
                <div class="row mb-3">
                  <div class="col-lg-3 col-md-4 col-12">
                    <label for="newOpt" class="form-control-label">Kategori</label>
                  </div>
                  <div class="col-lg-9 col-md-8 col-12">
                    <div class="custom-control custom-radio custom-control-inline">
                      <input type="radio" id="newOpt1" name="newOpt" class="custom-control-input" value="old" required="required" checked>
                      <label class="custom-control-label" for="newOpt1">Civitas</label>
                    </div>
                    <div class="custom-control custom-radio custom-control-inline">
                      <input type="radio" id="newOpt2" name="newOpt" class="custom-control-input" value="new" required="required">
                      <label class="custom-control-label" for="newOpt2">Lainnya (Umum)</label>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="row">
              <div class="col-lg-10 col-md-12">
                <div class="form-group">
                  <div class="row mb-3">
                    <div class="col-lg-3 col-md-4 col-12">
                      <label for="normal-input" class="form-control-label">Untuk</label>
                    </div>
                    <div class="col-lg-9 col-md-8 col-12">
                      <select class="form-control @error('status') is-invalid @enderror" name="status" required="required"/>
                        @foreach($status as $s)
                        <option value="{{ $s->id }}">{{ 'Anak '.$s->status }}</option>
                        @endforeach
                      </select>
                    </div>
                  </div>
          ...
          @else
          <input type="hidden" name="newOpt" value="new" required="required">
          <div id="newRow">
          @endif
            <div class="row">
              <div class="col-lg-10 col-md-12">
                <div class="form-group">
                  <div class="row mb-3">
                    ...
                    <div class="col-lg-9 col-md-8 col-12">
                      <input type="text" id="name" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" {{ $status && count($status) > 0 ? null : 'required="required"' }}/>
                    </div>
                  </div>
                </div>
              </div>
...
<script>
    $(document).ready(function () {
      $('input[name="newOpt"]').on('change',function(){
        var newOpt = $(this).val();
        if(newOpt == 'old'){
          $('select[name="status"]').prop("required", true);
          $('input[name="name"]').prop("required", false);
          $('#oldRow').show();
          $('#newRow').hide();
        }else{
          $('select[name="status"]').prop("required", false);
