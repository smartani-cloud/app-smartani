    ...
    <div class="card-body">
        <div class="col-md-8">
          ...
          <div class="form-group row">
              ...
              <div class="col-sm-5">
                  <select name="unit_id" class="select2 form-control select2-hidden-accessible auto_width" id="unit_id" style="width:80%;" tabindex="-1" aria-hidden="true">
          ...
          <div class="form-group row">
              ...
              <div class="col-sm-5">
                  <select name="year_start" class="select2 form-control select2-hidden-accessible auto_width" id="year_start" style="width:80%;" tabindex="-1" aria-hidden="true">
                    @foreach (getAcademicYearList() as $index => $year_list)
                    <option value="{{$year_list->id}}" {{$index==2?'selected':''}}>{{$year_list->academic_year}}</option>
                    @endforeach
                  </select>
              </div>
          </div>
          <div class="form-group row">
              ...
              <div class="col-sm-5">
                  <select name="year_end" class="select2 form-control select2-hidden-accessible auto_width" id="year_end" style="width:80%;" tabindex="-1" aria-hidden="true">
                      @foreach (getAcademicYearList() as $index => $year_list)
                      <option value="{{$year_list->id}}" {{$index==0?'selected':''}}>{{$year_list->academic_year}}</option>
                      @endforeach
                  </select>
              </div>
          </div>
