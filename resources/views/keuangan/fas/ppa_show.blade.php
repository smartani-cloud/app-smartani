...
<tr id="p-{{ $p->id }}">
    ...
    <td class="detail-value" style="min-width: 200px">
        ...
        @else
        @if(!$isAnggotaPa || $ppaAktif->finance_acc_status_id == 1 || !$apbyAktif || ($apbyAktif && $apbyAktif->is_active == 0))
...
@section('footer')
@if($ppaAktif->type_id != 2)
@if(($apbyAktif && $apbyAktif->is_active == 1) && $isAnggotaPa && $ppaAktif->finance_acc_status_id != 1)
<div class="row">
    <div class="col-12">
