        ...
        <div class="card">
            ...
            <div class="card-body p-3">
                ...
                <div class="row ml-1">
                    ...
                    @php
                    $apbyCount = $a->apby()->where('academic_year_id',$tahun->id)->whereNotNull('director_acc_status_id')->count();
                    @endphp
                    @if($apbyCount > 0)
                    @php
                    ...
                    <div class="col-md-6 col-12 mb-3">
                        <div class="row py-2 rounded border border-light mr-2">
                            <div class="col-8 d-flex align-items-center">
                                ...
                                <div>
                                    <a class="font-weight-bold text-dark" href="{{ route('ppa.index', ['jenis' => $jenisAktif->link, 'tahun' => $tahun->academicYearLink, 'anggaran' => $a->anggaran->link])}}">{{ $a->anggaran->name }}</a>
                                </div>
                            </div>
