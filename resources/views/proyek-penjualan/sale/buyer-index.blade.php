              ...
              <div class="form-group">
                <div class="row">
                  ...
                  <div class="col-lg-3 col-md-4 col-8">
                    <input type="text" id="phone_number" class="form-control form-control-sm @error('phone_number') is-invalid @enderror" name="phone_number" value="{{ old('phone_number') }}" placeholder="mis. 081234567890" maxlength="15">
                    @error('phone_number')
                    <span class="text-danger">{{ $message }}</span>
                    @enderror
                  </div>
            ...
            <div class="col-lg-10 col-md-12">
              <div class="form-group">
                <div class="row mb-3">
                  ...
                  <div class="col-lg-9 col-md-8 col-12">
                    <input type="text" id="shipping_to" class="form-control form-control-sm @error('shipping_to') is-invalid @enderror" name="shipping_to" value="{{ old('shipping_to') }}" maxlength="255" required="required">
                    @error('shipping_to')
                    <span class="text-danger">{{ $message }}</span>
                    @enderror
                  </div>
            ...
            <div class="col-lg-10 col-md-12">
              <div class="form-group">
                <div class="row mb-3">
                  ...
                  <div class="col-lg-9 col-md-8 col-12">
                    <input type="text" id="address1" class="form-control form-control-sm @error('address1') is-invalid @enderror" name="address1" value="{{ old('address1') }}" maxlength="255" required="required">
                    @error('address1')
                    <span class="text-danger">{{ $message }}</span>
                    @enderror
                  </div>
                ...
                <div class="row mb-3">
                  <div class="col-lg-9 offset-lg-3 col-md-8 offset-md-4 col-12">
                    <input type="text" id="address2" class="form-control form-control-sm @error('address2') is-invalid @enderror" name="address2" value="{{ old('address2') }}" maxlength="255">
                    @error('address2')
                    <span class="text-danger">{{ $message }}</span>
                    @enderror
                  </div>
              ...
              <div class="form-group">
                <div class="row">
                  ...
                  <div class="col-lg-2 col-md-3 col-6">
                    <input type="text" id="postal_code" class="form-control form-control-sm @error('postal_code') is-invalid @enderror" name="postal_code" value="{{ old('postal_code') }}" maxlength="5">
                    @error('postal_code')
                    <span class="text-danger">{{ $message }}</span>
                    @enderror
                  </div>
            ...
            <div class="col-lg-10 col-md-12">
              <div class="form-group">
                <div class="row">
                  ...
                  <div class="col-lg-3 col-md-4 col-8">
                    <input type="text" id="shipping_phone_number" class="form-control form-control-sm @error('shipping_phone_number') is-invalid @enderror" name="shipping_phone_number" value="{{ old('shipping_phone_number') }}" placeholder="mis. 081234567890" maxlength="15">
  ...
  <div class="col-12">
    <div class="card shadow">
      ...
      <div class="card-body">
        ...
        @endif
        @if($errors->has('editUnit') || $errors->has('editName') || $errors->has('editPhoneNumber') || $errors->has('editShippingTo') || $errors->has('editAddress1') || $errors->has('editPostalCode') || $errors->has('editShippingPhoneNumber'))
        <div class="alert alert-danger">
          <ul class="mb-0">
            @if($errors->has('editUnit'))
            <li>{{ $errors->first('editUnit') }}</li>
            @endif
            @if($errors->has('editName'))
            <li>{{ $errors->first('editName') }}</li>
            @endif
            @if($errors->has('editPhoneNumber'))
            <li>{{ $errors->first('editPhoneNumber') }}</li>
            @endif
            @if($errors->has('editShippingTo'))
            <li>{{ $errors->first('editShippingTo') }}</li>
            @endif
            @if($errors->has('editAddress1'))
            <li>{{ $errors->first('editAddress1') }}</li>
            @endif
            @if($errors->has('editPostalCode'))
            <li>{{ $errors->first('editPostalCode') }}</li>
            @endif
            @if($errors->has('editShippingPhoneNumber'))
            <li>{{ $errors->first('editShippingPhoneNumber') }}</li>
            @endif
          </ul>
        </div>
        @endif
          ...
          <table class="table table-bordered dataTable" id="dataTable" width="100%" cellspacing="0" role="grid" aria-describedby="dataTable_info" style="width: 100%;">
            ...
            <tbody>
              ...
              <tr>
                <td>{{ $no++ }}</td>
                @if(Auth::user()->role_id != 3)
                <td>{{ $d->unit ? $d->unit->name : '' }}</td>
                @endif
                <td>{{ $d->billing_to }}</td>
                <td>{{ $d->billing_phone_number }}</td>
                <td>{{ $d->shipping_to }}</td>
                <td>{{ $d->shipping_address }}</td>
                <td>{{ $d->shipping_phone_number }}</td>
                <td>
                  ...
                  @if($used && $used[$d->id] < 1)
                  <a href="#" class="btn btn-sm btn-danger" data-toggle="modal" data-target="#delete-confirm" onclick="deleteModal('{{ $active }}', '{!! addslashes(htmlspecialchars($d->billing_to)) !!}', '{{ route($route.'.destroy', ['id' => $d->id]) }}')"><i class="fas fa-trash"></i></a>
                  @else
