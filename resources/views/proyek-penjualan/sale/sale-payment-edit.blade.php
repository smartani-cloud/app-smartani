    ...
    <div class="col-md-12">
      <div class="form-group">
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 col-12">
            <input type="text" id="editPaymentBalance" class="form-control form-control-sm number-separator" name="edit_payment_balance" value="{{ number_format($data->sale->total_amount-$data->sale->payments()->sum('value'), 0, ',', '.') }}" maxlength="12" disabled="disabled">
          </div>
        </div>
      </div>
    </div>
