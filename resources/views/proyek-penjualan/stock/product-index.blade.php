              ...
              <div class="form-group">
                <div class="row">
                  ...
                  <div class="col-lg-4 col-md-6 col-12">
                    <input type="text" id="sku" class="form-control form-control-sm @error('sku') is-invalid @enderror" name="sku" value="{{ old('sku') }}" maxlength="15">
                    @error('sku')
                    <span class="text-danger">{{ $message }}</span>
                    @enderror
                  </div>
            ...
            <div class="col-lg-10 col-md-12">
              <div class="form-group">
                <div class="row mb-3">
                  ...
                  <div class="col-lg-4 col-md-6 col-12">
                    <select class="select2 form-control form-control-sm @error('category') is-invalid @enderror" name="category" id="selectCategory" required="required">
          ...
          <table class="table table-bordered dataTable" id="dataTable" width="100%" cellspacing="0" role="grid" aria-describedby="dataTable_info" style="width: 100%;">
            ...
            <tbody>
              ...
              <tr>
                <td>{{ $no++ }}</td>
                <td>{{ $d->name }}</td>
                <td>{{ $d->sku_number ? $d->sku_number : '' }}</td>
                <td>{{ $d->unit ? $d->unit->name : '' }}</td>
                <td>{{ $d->category ? $d->category->name : '' }}</td>
                <td>
