...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Pengaturan Jumlah NH</h1>
    <ol class="breadcrumb">
    ...
    <div class="col-md-12">
        <div class="card h-100">
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                        <form action="{{route('kd.simpan')}}" method="POST">
                            @csrf
