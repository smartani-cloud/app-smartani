                    ...
                    <div class="col-md-8">
                        ...
                        <div class="card-footer">
                            <div class="alert alert-secondary" role="alert">
                                <strong>Catatan</strong> : Harap isikan predikat dan deskripsi dengan lengkap yaitu meliputi predikat A, B, C, dan D pada menu Predikat Pengetahuan. Kekurangan dalam pengaturan predikat dan deskripsi akan membuat data tidak tersimpan dan berpengaruh pada tampilan cetak rapor.
                            </div>
...
<script>
    ...
    function getsiswa(id) {
        ...
        $.ajax({
            url: "{{ route('pengetahuan.getsiswa') }}",
            data: {
                'class_id': id,
                'mapel_id': mapel,
                'level_id': level
