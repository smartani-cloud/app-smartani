...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <ol class="breadcrumb">
        ...
        @if($semester || $kelas)
        <li class="breadcrumb-item"><a href="{{ route('mapel.pengetahuan.index') }}">Nilai Pengetahuan</a></li>
        @else
        <li class="breadcrumb-item active" aria-current="page">Nilai Pengetahuan</li>
        @endif
        @if($semester)
        @if($kelasList && $kelas)
        <li class="breadcrumb-item"><a href="{{ route('mapel.pengetahuan.index', ['tahun' => $semester->tahunAjaran->academicYearLink, 'semester' => $semester->semesterNumber])}}">{{ $semester->semester_id . ' (' .$semester->semester.')' }}</a></li>
        @else
              ...
              <div class="form-group mb-0">
                <div class="row mb-2">
                  ...
                  <div class="col-lg-8 col-md-8 col-12">
                    ...
                    <a href="{{ route('mapel.pengetahuan.index') }}" id="btn-select-year" class="btn btn-brand-green ml-2 pt-2" data-href="{{ route('mapel.pengetahuan.index') }}">Atur</a>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="row mb-2">
                  ...
                  <div class="col-lg-8 col-md-8 col-12">
                    ...
                    <div class="input-group">
                        ...
                        <a href="{{ route('mapel.pengetahuan.index', ['tahun' => $semester->tahunAjaran->academicYearLink, 'semester' => $semester->semesterNumber]) }}" id="btn-select-class" class="btn btn-brand-green ml-2 pt-2" data-href="{{ route('mapel.pengetahuan.index', ['tahun' => $semester->tahunAjaran->academicYearLink, 'semester' => $semester->semesterNumber]) }}">Pilih</a>
                    </div>
                    @endif
                  </div>
                </div>
...
<form action="{{ route('mapel.pengetahuan.perbarui', ['tahun' => $semester->tahunAjaran->academicYearLink, 'semester' => $semester->semesterNumber, 'kelas' => $kelas->id, 'mataPelajaran' => $mataPelajaran->id]) }}" id="knowledge-form" method="post" enctype="multipart/form-data" accept-charset="utf-8">
{{ csrf_field() }}
<div class="row mb-4">
  <div class="col-12">
    <div class="card">
          ...
          <div class="row">
            <div class="col-lg-8 col-md-10 col-12">
              <div class="form-group mb-0">
                ...
                <div class="row">
                    <div class="col-md-3">
                        <input type="number" name="persenkd" placeholder="Penilaian Harian" value="{{ $persentase ? $persentase->precentage_kd : '' }}" class="form-control">
                    </div>
                    <div class="col-md-3">
                        <input type="number" name="persenpts" placeholder="PTS" value="{{ $persentase ? $persentase->precentage_pts : '' }}" class="form-control">
                    </div>
                    <div class="col-md-3">
                        <input type="number" name="persenpas" placeholder="PAS" value="{{ $persentase ? $persentase->precentage_pas : '' }}" class="form-control">
                    </div>
                    <div class="col-md-3">
                        <input type="number" name="persenproject" placeholder="Project" value="{{ $persentase ? $persentase->precentage_project : '' }}" class="form-control">
                    </div>
                </div>
              </div>
            </div>
                    ...
                    <div class="table-responsive">
                        <table class="table align-items-center table-sm" style="width:100%">
                            ...
                            <tbody>
                                ...
                                if($rapor) $raporCount++;
                                $pengetahuan = $rapor ? $rapor->pengetahuan()->where('subject_id',$mataPelajaran->id)->first() : null;
                                @endphp
                                <tr>
                                    ...
                                    <td>
                                        @php
                                        $scoreSkill = $pengetahuan && isset($pengetahuan->nilaipengetahuandetail[$i-1]) ? $pengetahuan->nilaipengetahuandetail[$i-1]->score : '';
                                        @endphp
                                    ...
                                    @endif
                                    <td>
                                        <input type="number" class="form-control mx-auto" name="s-{{$s->id}}-pts" min="0" max="100" value="{{ $pengetahuan ? $pengetahuan->pts : '' }}" style="width: 70px;">
                                    </td>
                                    <td>
                                        <input type="number" class="form-control mx-auto" name="s-{{$s->id}}-pas" min="0" max="100" value="{{ $pengetahuan ? $pengetahuan->pas : '' }}" style="width: 70px;">
                                    </td>
                                    <td>
                                        <input type="number" class="form-control mx-auto" name="s-{{$s->id}}-project" min="0" max="100" value="{{ $pengetahuan ? $pengetahuan->project : '' }}" style="width: 70px;">
                                    </td>
                                    @php
                                    $na = $pengetahuan && $pengetahuan->score_knowledge ? number_format((float)$pengetahuan->score_knowledge, 0, ',', '') : 0;
                                    @endphp
                                    <td>
                                        <input type="text" class="form-control mx-auto" name="s-{{$s->id}}-na" min="0" max="100" value="{{ $na }}" style="width: 70px;" disabled>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
