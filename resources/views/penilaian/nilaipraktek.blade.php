...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Nilai Praktek</h1>
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="javascript:void(0)">Penilaian</a></li>
        <li class="breadcrumb-item active" aria-current="page">Nilai Praktek</li>
    </ol>
</div>
...
<script>
    ...
    function getkelas() {
        ...
        $.ajax({
            url: "{{ route('nilaipraktek.getkelas') }}",
            data: {
                'mapel_id': mapel,
                'level_id': id
            },
    ...
    function getsiswa(id) {
        ...
        $.ajax({
            url: "{{ route('nilaipraktek.getsiswa') }}",
            data: {
                'class_id': id,
                'mapel_id': mapel,
                'level_id': level
