                ...
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <select name="rombel_id" class="form-control" id="rombel" onchange="getEkstra(this.value)" style="width:100%;" tabindex="-1" aria-hidden="true">
                                    @if ($siswa)
                    ...
                    <div class="col-md-12" id="getEkstra">&nbsp;</div>
                </div>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    function getEkstra(id) {
        ...
        $.ajax({
            url: "{{ route('ekstra.getEkstra') }}",
            data: {
                'siswa_id': id
            },
            type: 'POST',
            success: function(response) {
                $('#getEkstra').html(response.html);
            },
