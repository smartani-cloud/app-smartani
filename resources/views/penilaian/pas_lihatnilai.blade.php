                    ...
                    <div class="m-t-16 m-b-16">
                        <table class="table-border page-break-auto">
                            ...
                            <tr>
                                ...
                                <td class="text-center" colspan="2">{{ number_format((float)($totalPengetahuan/$mapelCount), 0, ',', '') }}</td>
                                <td class="text-center" colspan="2">{{ number_format((float)($totalKeterampilan/$mapelCount), 0, ',', '') }}</td>
                            </tr>
                        </table>
                    </div>
                </div>
                ...
                <div class="m-l-18">
                    <div class="m-t-8 m-b-16">
                        <table class="table-border">
                            ...
                            @php
                            $category_active = null;
                            $indikators = $rapor->kelas->level->indikatorIklas->detail;
                            @endphp
