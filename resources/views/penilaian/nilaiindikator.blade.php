...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Nilai Indikator</h1>
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="javascript:void(0)">Penilaian</a></li>
        <li class="breadcrumb-item active" aria-current="page">Nilai Indikator</li>
    </ol>
</div>
                ...
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <select name="rombel_id" class="form-control" id="rombel" onchange="getNilai(this.value)" style="width:100%;" tabindex="-1" aria-hidden="true">
                    ...
                    <div class="col-md-12" id="getNilai">&nbsp;</div>
                </div>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    function getNilai(id) {
        ...
        $.ajax({
            url: "{{ route('nilaiindikator.getNilai') }}",
            data: {
                'siswa_id': id
            },
            type: 'POST',
            success: function(response) {
                $('#getNilai').html(response.html);
            },
