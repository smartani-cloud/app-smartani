...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Predikat & Deskripsi Keterampilan</h1>
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="javascript:void(0)">Penilaian</a></li>
        <li class="breadcrumb-item active" aria-current="page">Predikat Keterampilan</li>
    </ol>
</div>
...
<div class="modal fade" id="TambahModal" tabindex="-1" role="dialog" aria-labelledby="TambahModalTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form action="{{route('predikatketerampilan.tambah')}}" method="POST">
                @csrf
...
<div class="modal fade" id="UbahModal" tabindex="-1" role="dialog" aria-labelledby="UbahModalTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form action="{{route('predikatketerampilan.ubah')}}" method="POST">
                @csrf
    ...
    <div class="modal-dialog modal-confirm">
        <div class="modal-content">
            ...
            <div class="modal-footer justify-content-center">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
                <form action="{{route('predikatketerampilan.hapus')}}" method="POST">
                    @csrf
...
<script>
    ...
    function getlevel(id) {
        ...
        $.ajax({
            url: "{{ route('predikatketerampilan.getlevel') }}",
            data: {
                'mapel_id': id
            },
            type: 'POST',
    ...
    function getdeskripsi(id) {
        ...
        $.ajax({
            url: "{{ route('predikatketerampilan.getdesc') }}",
            data: {
                'level_id': id,
                'mapel_id': mapel_id
            },
