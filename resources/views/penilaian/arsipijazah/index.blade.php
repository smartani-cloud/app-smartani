...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Arsip Ijazah</h1>
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="javascript:void(0)">Penilaian</a></li>
        <li class="breadcrumb-item active" aria-current="page">Arsip Ijazah</li>
    </ol>
</div>
                    ...
                    <div class="col-md-12">
                        <table class="table align-items-center table-flush">
                            ...
                            <tbody>
                                ...
                                <form action="/kependidikan/ijazah/arsip/store" method="POST" enctype="multipart/form-data">
                                    @csrf
                        ...
                        <!-- <p><strong style="color:red;">*)</strong> Hanya untuk siswa kelas</p> -->
