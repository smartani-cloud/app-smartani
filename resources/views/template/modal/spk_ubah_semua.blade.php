  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header bg-brand-purple border-0">
        <h5 class="modal-title text-white">Atur Perjanjian Kerja Sekaligus</h5>
      ...
      <div class="modal-body p-4">
        <form action="{{ route('spk.perbarui.semua') }}" id="spk-form" method="post" enctype="multipart/form-data" accept-charset="utf-8">
          {{ csrf_field() }}
          {{ method_field('PUT') }}
          <div class="row">
            <div class="col-12">
