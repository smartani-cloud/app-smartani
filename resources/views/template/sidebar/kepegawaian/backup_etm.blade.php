...
@section('sidebar-menu')
      ...
      <li class="nav-item {{ request()->routeIs('calon*') || request()->routeIs('evaluasi*') || request()->routeIs('spk*') || request()->routeIs('pendidikanterakhir*') || request()->routeIs('programstudi*') ? 'active' : '' }}">
        ...
        <div id="collapseRekrutmen" class="collapse {{ request()->routeIs('calon*') || request()->routeIs('evaluasi*') || request()->routeIs('spk*') || request()->routeIs('pendidikanterakhir*') || request()->routeIs('programstudi*') || request()->routeIs('universitas*') ? 'show' : '' }}" aria-labelledby="headingRekrutmen" data-parent="#accordionSidebar" style="">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item {{ request()->routeIs('evaluasi*') ? 'active' : '' }}" href="{{ route('evaluasi.index') }}">
