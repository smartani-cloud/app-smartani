                      ...
                      <table class="table align-items-center table-sm" style="width:100%">
                        <thead class="bg-brand-green text-white">
                          <tr>
                            ...
                            <th class="text-center">Elemen Capaian Pembelajaran</th>
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td {!! 'rowspan="'.$rowspan.'"' !!}>{{ $o->element->dev_aspect }}</td>
                            <td {!! isset($class[$o->objective_id]) ? 'class="'.$class[$o->objective_id].'"' : null !!} style="vertical-align: middle;">{{ $o->objective->desc }}</td>
                            <td {!! 'rowspan="'.$rowspan.'"' !!}>
                              @if(isset($nilai[$siswa->id][$o->element_id]['tinggi']) || isset($nilai[$siswa->id][$o->element_id]['rendah']))
                              <ul>
                                <li>{!! isset($nilai[$siswa->id][$o->element_id]['tinggi']) ? $nilai[$siswa->id][$o->element_id]['tinggi'] : '-' !!}</li>
                                @if(isset($nilai[$siswa->id][$o->element_id]['rendah']))
                                <li>{!! $nilai[$siswa->id][$o->element_id]['rendah'] !!}</li>
                                @endif
                              </ul>
                              @endif
                            </td>
    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body p-3">
                ...
                @endif
                @if($objectives && count($objectives) > 0 && isset($count['elements']) && $count['elements'] > 0 && (!isset($count['desc']) || ($count['desc'] && $count['desc'] < (2*$count['elements']))))
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                      ...
                                      @else
                                      <a href="{{ route($route.'.index', ['tahun' => $semester->tahunAjaran->academicYearLink, 'semester' => $semester->semesterNumber, 'kelas' => $kelas->id, 'siswa' => $r->studentNisLink]) }}" class="btn btn-sm btn-brand-green-dark"><i class="fas fa-eye"></i></a>
                                      @endif
                                    </td>
                                </tr>
                                @endforeach
