                      ...
                      @foreach($data as $d)
                        <tr>
                            ...
                            <td>
                                ...
                                @if($used && $used[$d->id] < 1)
                                <a href="#" class="btn btn-sm btn-danger" data-toggle="modal" data-target="#delete-confirm" onclick="deleteModal('{{ $active }}', '{{ addslashes(htmlspecialchars($d->name)) }}', '{{ route($route.'.destroy', ['unit' => $unit->name,'id' => $d->id]) }}')"><i class="fas fa-trash"></i></a>
                                @else
            ...
            <div class="col-md-12">
              <div class="form-group">
                <div class="row">
                  ...
                  <div class="col-12">
                    <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" maxlength="50" required="required"/>
                    @error('name')
                    <span class="text-danger">{{ $message }}</span>
                    @enderror
                  </div>
