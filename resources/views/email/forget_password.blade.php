...
<head>
    ...
    <meta name="description" content="Reset Password SISTA.">
    <style type="text/css">
                            ...
                            <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td style="padding:0 35px;">
                                        <h1 style="color:#1e1e2d; font-weight:600; margin:0;font-size:32px;font-family:'SourceSansPro',sans-serif;">Permintaan Reset Sandi</h1>
                                        <span
                                            style="display:inline-block; vertical-align:middle; margin:29px 0 26px; border-bottom:1px solid #cecece; width:100px;"></span>
                                        <p style="color:#455056; font-size:15px;line-height:24px; margin:0;">
                                            Baru-baru ini kami menerima permintaan untuk mereset sandi akun SISTA Anda. Jika Anda tidak melakukannya, silahkan abaikan email ini. Email ini akan kadaluarsa setelah 2 jam.
                                        </p>
                                        <a href="{{ route('reset.password.get', $token) }}"
                                            style="background:#bd59d4;text-decoration:none !important; font-weight:500; margin-top:35px; color:#fff;text-transform:uppercase; font-size:14px;padding:10px 24px;display:inline-block;border-radius:50px;">Reset
                                            Sandi</a>
                                    </td>
                                </tr>
                                <tr>
